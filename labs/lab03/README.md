...
Ниже пример, с полной конфигурацией каждым из маршрутизаторов можно ознакомиться [тут](https://github.com/Samsonvl/network-otus/tree/master/labs/lab03/config)
...
Ниже пример, с полной конфигурацией каждым из коммутаторов можно ознакомиться [тут](https://github.com/Samsonvl/network-otus/tree/master/labs/lab03/config)
